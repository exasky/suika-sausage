...
export const MERGE_SETS: Record<string, SetDefinition> = {
  ...
  explosives: {
    ...
    items: [
      ...
      { key: '7_mine', name: 'Mine', radius: 64, score: 28 },
      { key: '8_roquette', name: 'Roquette', radius: 72, score: 36 },
      { key: '9_missile', name: 'Missile', radius: 85, score: 45 },
  ...
  cats: {
    ...
    items: [
      ...
      { key: '2_singapura', name: 'Singapura', radius: 19, score: 3 },
      { key: '3_munchkin', name: 'Munchkin', radius: 24, score: 6 },
      { key: '4_siamois', name: 'Siamois', radius: 30, score: 10 },
      { key: '5_sphynx', name: 'Sphynx', radius: 37, score: 15 },
      { key: '6_europien', name: 'Européen', radius: 44, score: 21 },
      { key: '7_chartreux', name: 'Chartreux', radius: 50, score: 28 },
      { key: '8_bengal', name: 'Bengal', radius: 60, score: 36 },
      { key: '9_persan', name: 'Persan', radius: 73, score: 45 },
      { key: '10_ragdoll', name: 'Ragdoll', radius: 91, score: 55 },
      { key: '11_maine_coon', name: 'Maine Coon', radius: 112, score: 66 },
    ],
  },
};
