...
export const MERGE_SETS = {
  ...
  cheeses: {
    ...
    items: [
      ...
      { key: '5_rocamadour', name: 'Rocamadour', radius: 48, score: 15 },
      { key: '6_camembert', name: 'Camembert', radius: 60, score: 21 },
      { key: '7_munster', name: 'Munster', radius: 74, score: 28 },
      { key: '8_reblochon', name: 'Reblochon', radius: 83, score: 36 },
      { key: '9_roquefort', name: 'Roquefort (Quart)', radius: 90, score: 45 },
      { key: '10_brie', name: 'Brie de Meaux (Pointe)', radius: 100, score: 55 },
      { key: '11_meule_comte', name: 'Meule de Comté', radius: 120, score: 66 },
    ],
  },
};
